...
def find_rotation_closed_form_iterative(m1: SpectralMesh,
    ...
    for iter_recon in range(len(opts['niter'])):
        ...
        for iter in range(opts['niter'][iter_recon]):
            ...
            #print(f'corr_12 = {find_closest_points_in_spectral_domain(Z_1_o, Z_2).shape}\n')
            corr['corr_21'] = find_closest_points_in_spectral_domain(Z_2_o, Z_1)
            #print(f'corr_21 = {find_closest_points_in_spectral_domain(Z_2_o, Z_1).shape}\n')
            ...
            if data_term:
                ...
                Z_2 = Y_2
        #err_per_kr.append(sum(errs_X))
        Z_1_stages.append(Z_1.copy())
        Z_2_stages.append(Z_2.copy())
        kr_stages = opts['kr']
        #print(f"stage has error: {sum(errs_X)}")
    #print(f'C_12 = {C_12}\n')
    #print(f'C_12 = {C_12.shape}\n')
    #print(f'C_21 = {C_21}\n')
    #print(f'C_21 = {C_21.shape}\n')
    #print(f'R_12 = {R_12}\n')
    #print(f'R_12 = {R_12.shape}\n')
    #print(f'R_21 = {R_21}\n')
    #print(f'R_21 = {R_21.shape}\n')
    ...
    corr['errs_X'] = errs_X
    corr['errs_Z'] = errs_Z
    corr['Z_1_stages'] = Z_1_stages
    corr['Z_2_stages'] = Z_2_stages
    corr['kr_stages'] = kr_stages
